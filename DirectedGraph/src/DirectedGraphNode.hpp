...
namespace dgn
{
        ...
        namespace details
        {
                ...
                public:
                        ...
                        DirectedGraphNode(DirectedGraph<T, Allocator> &graph, const T &data, const Allocator &allocator);
                        DirectedGraphNode(DirectedGraph<T, Allocator> &graph, T &&data, const Allocator &allocator);
                ...
                template <typename T, typename Allocator>
                DirectedGraphNode<T, Allocator>::DirectedGraphNode(DirectedGraph<T, Allocator> &graph, const T &data)
                    : DirectedGraphNode<T, Allocator>{graph, data, Allocator()}
                {
                }

                template <typename T, typename Allocator>
                DirectedGraphNode<T, Allocator>::DirectedGraphNode(DirectedGraph<T, Allocator> &graph, const T &data, const Allocator &allocator)
                    : DirectedGraphNodeAllocator<T, Allocator>{allocator},
                      m_graph{graph}
                {
                ...
                template <typename T, typename Allocator>
                DirectedGraphNode<T, Allocator>::DirectedGraphNode(DirectedGraph<T, Allocator> &graph, T &&data)
                    : DirectedGraphNode<T, Allocator>{graph, std::move(data), Allocator{}}
                {
                }

                template <typename T, typename Allocator>
                DirectedGraphNode<T, Allocator>::DirectedGraphNode(DirectedGraph<T, Allocator> &graph, T &&data, const Allocator &allocator)
                    : DirectedGraphNodeAllocator<T, Allocator>{allocator},
                      m_graph{graph}
                {
                ...
                template <typename T, typename Allocator>
                DirectedGraphNode<T, Allocator>::DirectedGraphNode(DirectedGraphNode &&src) noexcept
                ...
                DirectedGraphNode<T, Allocator>::operator=(const DirectedGraphNode<T, Allocator> &rhs)
                {
                        if (this != &rhs)
                        {
                ...
                template <typename T, typename Allocator>
                typename DirectedGraphNode<T, Allocator>::DirectedGraphNode &
                DirectedGraphNode<T, Allocator>::operator=(DirectedGraphNode<T, Allocator> &&rhs) noexcept
                {
                ...
                template <typename T, typename Allocator>
                bool DirectedGraphNode<T, Allocator>::operator==(const DirectedGraphNode<T, Allocator> &rhs) const
                {
