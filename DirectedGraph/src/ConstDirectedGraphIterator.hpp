...
namespace dgn
{
        ...
        public:
                ...
                using iterator_type = typename GraphType::nodesContainerType::const_iterator;

                ConstDirectedGraphIterator() = default;

                constexpr ConstDirectedGraphIterator(iterator_type it, const GraphType &graph);
        ...
        template <typename GraphType>
        constexpr ConstDirectedGraphIterator<GraphType>::ConstDirectedGraphIterator(iterator_type it, const GraphType &graph)
            : m_iterator{it},
              m_graph{graph}
        {
        }
        ...
        operator-(const typename ConstDirectedGraphIterator<GraphType>::iterator_type &lhs,
                  const typename ConstDirectedGraphIterator<GraphType>::iterator_type &rhs) noexcept
        {
                return lhs - rhs;
        }
