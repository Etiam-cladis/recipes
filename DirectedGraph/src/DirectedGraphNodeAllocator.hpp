...
namespace dgn
{
        ...
        namespace details
        {
                ...
                protected:
                        ...
                        DirectedGraphNodeAllocator &operator=(const DirectedGraphNodeAllocator &) = delete;
                        DirectedGraphNodeAllocator &operator=(DirectedGraphNodeAllocator &&) noexcept = delete;
                ...
                DirectedGraphNodeAllocator<T, Allocator>::DirectedGraphNodeAllocator(const Allocator &allocator)
                ...
                template <typename T, typename Allocator>
                DirectedGraphNodeAllocator<T, Allocator>::DirectedGraphNodeAllocator(DirectedGraphNodeAllocator &&src) noexcept
