...
namespace dgn
{
        ...
        template <typename GraphType>
        constexpr DirectedGraphIterator<GraphType>::DirectedGraphIterator(iterator_type it, const GraphType &graph)
        ...
        DirectedGraphIterator<GraphType>::operator-(difference_type n) noexcept
        {
                return DirectedGraphIterator<GraphType>{this->m_iterator - n, this->m_graph};
        }
        ...
        template <typename GraphType>
        constexpr typename DirectedGraphIterator<GraphType>::difference_type
        operator-(const typename DirectedGraphIterator<GraphType>::iterator_type &lhs,
                  const typename DirectedGraphIterator<GraphType>::iterator_type &rhs) noexcept
        {
                return lhs - rhs;
        }
        ...
        template <typename GraphType>
        bool operator<(typename DirectedGraphIterator<GraphType>::iterator_type lhs, typename DirectedGraphIterator<GraphType>::iterator_type rhs)
        {
                return (rhs - lhs) > 0;
        }
