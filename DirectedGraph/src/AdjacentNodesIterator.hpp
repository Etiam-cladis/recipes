...
namespace dgn
{
        ...
        template <typename GraphType>
        AdjacentNodesIterator<GraphType>::AdjacentNodesIterator(iterator_type it, const GraphType &graph)
        ...
        template <typename GraphType>
        AdjacentNodesIterator<GraphType> &
        AdjacentNodesIterator<GraphType>::operator++()
        {
                this->increment();
                return *this;
        }
        ...
        template <typename GraphType>
        AdjacentNodesIterator<GraphType>
        AdjacentNodesIterator<GraphType>::operator++(int)
        {
                auto oldIt{*this};
                this->increment();
                return oldIt;
